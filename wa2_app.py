        ...
        if ENABLE_SESSION_TOPLISTS:
            ...
            def _leaderboard_section():
                ...
                st.markdown(
                    ...
                    " The leaderboards might look weird for a while until people get enough games. Some/most metrics have a game requirement (usually 50). Any suggestions are appreciated, and can be sent either private or under the Info/Explanations tab.</div>",
                    unsafe_allow_html=True,
                )
                _lb_season = st.radio(
                    "Leaderboard season",
